...
@NonNullApi
public class KMPAppTemplateNativeProjectDependency extends DelegatingProjectDependency {

    @Inject
    public KMPAppTemplateNativeProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
